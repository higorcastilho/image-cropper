...
let startX, startY, relativeStartX, relativeStartY, endX,
endY, relativeEndX, relativeEndY
...
cropButton.onclick = () => {
	...
	//pegar do ctx do canvas a imagem cortada
